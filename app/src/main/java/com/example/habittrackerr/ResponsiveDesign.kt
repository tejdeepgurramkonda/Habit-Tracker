...
fun createResponsiveDimensions(): ResponsiveDimensions {
    ...
    return when (screenSize) {
        ScreenSize.SMALL -> ResponsiveDimensions(
            ...
            screenPadding = (16.dp * scaleFactor),
            cardElevation = (4.dp * scaleFactor),
            profileImageSize = (40.dp * scaleFactor)
        )
        ...
        ScreenSize.MEDIUM -> ResponsiveDimensions(
            ...
            captionTextScale = scaleFactor,
            screenPadding = (24.dp * scaleFactor),
            cardElevation = (6.dp * scaleFactor),
            profileImageSize = (50.dp * scaleFactor)
        )
        ...
        ScreenSize.LARGE -> ResponsiveDimensions(
            ...
            captionTextScale = scaleFactor,
            screenPadding = (32.dp * scaleFactor),
            cardElevation = (8.dp * scaleFactor),
            profileImageSize = (60.dp * scaleFactor)
        )
    }
}
